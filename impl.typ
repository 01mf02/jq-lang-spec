...
based on the semantics in @semantics.
...
#[
#set raw(lang: none)
#figure(caption: "Runtime for various benchmarks, in milliseconds. Lower is better.", table(columns: 4, align: (left, right, right, right),
  table.header([Benchmark], [jaq-2.0], [jq-1.7.1], [gojq-0.12.16]),
  [`empty`        ], [  300], [  500], [*230*],
  [`bf-fib`       ], [*440*], [ 1230], [  570],
  [`defs`         ], [ *60*], [  N/A], [ 1020],
  [`upto`         ], [  *0*], [  470], [  460],
...
#figure(caption: "Filter runtime in milliseconds with input 1000000. Lower is better.", table(columns: 4, align: (left, right, right, right),
  table.header([Filter], [jaq-2.0], [jq-1.7.1], [gojq-0.12.16]),
  [`[range(.)]`             ], [ *44*], [ 159], [ 178],
