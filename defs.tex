...
\newcommand{\mathoc}[1]{\mathopen{}#1\mathclose{}}

<!-- jq syntax -->
\newcommand{\jqf }[1]{\mathtt{#1}}
\newcommand{\jqkw}[1]{\mathrel{\jqf{#1}}}
\newcommand{\jqstr}[1]{\text{"#1"}}
\newcommand{\jqas}{\jqkw{as}}
\newcommand{\jqdef }[2]{\mathoc{\jqkw{def} #1\!: #2;\;}}
\newcommand{\jqite }[3]{\mathoc{\jqkw{if} #1 \jqkw{then} #2 \jqkw{else} #3 \jqkw{end}}}
\newcommand{\jqfold}[4]{\mathoc{\jqkw{#1} #2 \jqas #3\; #4}}
\newcommand{\jqlb  }[2]{\mathoc{\jqkw{#1}\, \$#2}}
\newcommand{\jqtc  }[2]{\mathoc{\jqkw{try} #1 \jqkw{catch} #2}}
...
\newcommand{\bindr}{\bind_\mathcal{R}}
\newcommand{\bindl}{\bind_{\stream{}}}
\newcommand{\map}{\operatorname{map}}
\newcommand{\mapr}{\map_\mathcal{R}}
\newcommand{\mapl}{\map_{\stream{}}}

<!-- types -->
\newcommand{\boolt}{\mathbb{B}}
\newcommand{\valt}{\mathcal{V}}
\newcommand{\optt}{\mathcal{O}}
\newcommand{\listt}{\mathcal{L}}
\newcommand{\resultt}{\mathcal{R}}
\newcommand{\filtert}{\mathcal{F}}
\newcommand{\valpatht}{\mathcal{V}_\mathcal{P}}
